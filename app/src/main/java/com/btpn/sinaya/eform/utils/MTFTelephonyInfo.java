...
public final class MTFTelephonyInfo {

    private static MTFTelephonyInfo telephonyInfo;
    ...
    private MTFTelephonyInfo() {
    }

    public static MTFTelephonyInfo getInstance(Context context){

        if(telephonyInfo == null) {

            telephonyInfo = new MTFTelephonyInfo();
