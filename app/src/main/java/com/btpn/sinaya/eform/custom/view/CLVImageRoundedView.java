...
public class CLVImageRoundedView extends ImageView {

    public CLVImageRoundedView(Context context) {
        super(context);
    }

    public CLVImageRoundedView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CLVImageRoundedView(Context context, AttributeSet attrs, int defStyle) {
