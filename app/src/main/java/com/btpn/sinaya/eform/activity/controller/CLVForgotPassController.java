...
public class CLVForgotPassController implements View.OnClickListener, View.OnKeyListener {
    private int codeFailed;
    private CLVForgotPassActivity activity;
...
//    };
    ...
    public CLVForgotPassController(CLVForgotPassActivity activity) {
