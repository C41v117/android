...
public class CLVSearchController implements View.OnClickListener, View.OnKeyListener {
    private int codeFailed;
    private CLVSearchActivity activity;
...
//    };
    ...
    public CLVSearchController(CLVSearchActivity activity) {
